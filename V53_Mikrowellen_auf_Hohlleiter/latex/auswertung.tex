...
Die gemesseenen Werte der $\SI{3}{dB}$-Methode sind nachfolgend aufgelistet.
...
Nun kann das Stehwellenverhältnis $S_2$ über \autoref{eq:3dB_Methode} bestimmt werden.
Es ergibt sich
\begin{equation*}
    S_2 = \num{8.987} \, .
\end{equation*}
